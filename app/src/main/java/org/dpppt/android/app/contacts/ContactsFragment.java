...
import org.dpppt.android.app.inject.ViewModelFactory;
...
public class ContactsFragment extends Fragment {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        MainApplication.Companion.getAppComponent(context).inject(this);
    }

    @Override
    public void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        tracingViewModel = new ViewModelProvider(requireActivity(), viewModelFactory).get(TracingViewModel.class);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tracingViewModel.getErrorsLiveData().observe(getViewLifecycleOwner(), errorStates -> tracingSwitch.setEnabled(errorStates.isEmpty()));
        ...
        tracingViewModel.getBluetoothEnabledLiveData().observe(getViewLifecycleOwner(), bluetoothEnabled -> bluetoothButton.setVisibility(bluetoothEnabled ? View.GONE : View.VISIBLE));
